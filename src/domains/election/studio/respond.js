...
const REALISERS = Object.freeze({
  en: {
    ...
    noCoverageData: () => "Forge Election Canon has no wards or polling units recorded yet.",
    incidentSummary: (text) => text,
    noIncidents: () => "Forge Election Canon has no incidents recorded.",
    evidenceSummary: (text) => text,
    noEvidence: () => "Forge Election Canon has no results captured yet.",
    ocrSummary: (text) => text,
    noOcr: () => "Forge Election Canon has no OCR-processed results yet.",
    resultsSubmittedSummary: (text) => text,
    noResultsSubmitted: () => "Forge Election Canon has no polling units or results recorded yet.",
    disputedResultsSummary: (text) => text,
    noDisputedResults: () => "Forge Election Canon has no results captured yet.",
    highPriorityIncidentsSummary: (text) => text,
    noHighPriorityIncidents: () => "Forge Election Canon has no incidents recorded.",
    notReportingSummary: (text) => text,
    noNotReportingData: () => "Forge Election Canon has no polling units recorded yet.",
    coveragePercentSummary: (text) => text,
    noCoveragePercentData: () => "Forge Election Canon has no polling units recorded yet.",
