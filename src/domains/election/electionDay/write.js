...
// user IS authorised and Approve is about to succeed. If Approve genuinely
// fails, that is reported separately, in `error`/friendlyError() — never
// folded into this notice.
