// ============================================================
// FORGE PIDGIN RESPONSE REALISATION — REFUSES UNTIL REVIEWED  (Alpha 1.2)
...
export const REFUSAL = Object.freeze({
  NO_APPROVED_PATTERN: "no approved Pidgin sentence pattern for this intent",
  NO_APPROVED_VOCABULARY: "no approved Pidgin vocabulary for this response",
