// ============================================================
// FORGE HAUSA RESPONSE REALISATION — REFUSES UNTIL REVIEWED  (Alpha 1.2)
// Same seam as ../urhobo/responses.js — see that file's header for why a
// refusing module is worth committing. `realisationAvailable()` returns
// false: no sentence pattern is approved, so `ha` never appears in
// REALISED_LANGUAGES until a reviewer changes that.
// ============================================================
...
export const REFUSAL = Object.freeze({
  NO_APPROVED_PATTERN: "no approved Hausa sentence pattern for this intent",
  NO_APPROVED_VOCABULARY: "no approved Hausa vocabulary for this response",
